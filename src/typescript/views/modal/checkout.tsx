...
import { EStepperOperationType, Stepper } from "../../components/stepper";
    ...
    <div id="checkout">
        ...
        <>
            <section className="bag-items">
            {
                ...
                {
                    (props.products.map((ctProduct) => 
                
                    <CartItem key={ ctProduct.id } product={ ctProduct } setProducts={ props.setProducts } />
                ...
                <div className="empty-state">
                    ...
                    children=
                    {
                        ...
                        className="secondary">Add Items</button>
                    }/>
                </div>
            ...
            <div className="details">
                ...
                <div className="pricing">
                    ...
                    <Stepper
                        ...
                        onStepperChange={ (value, operation) => 
                        {

                            props.setProducts({ product: props.product, count: (operation == EStepperOperationType.increment) ? 1 : -1 });
                            setCount(value); 
                        }}
                    />
                </div>
