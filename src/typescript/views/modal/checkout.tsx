        ...
        <>
            <section className="bag-items">
            {
                ...
                <Grid gap={{ x: 1, y: 1 }} minItemWidth={ 300 } contentItems=
                {
                    ...
                    <CartItem key={ ctProductIndex } product={ ctProduct } setProducts={ props.setProducts } />
...
{
    let referenceCount = props.product.quantity; 
            ...
            <div className="details">
                ...
                <div className="pricing">
                    ...
                    <Stepper
                        ...
                        {
                            const difference = value - referenceCount; 
                            props.setProducts({ product: props.product, count: difference });
